describe ('Create Wire with New Beneficiary, Cash Pick Up, and Local Currency', function(){
    ...
    it ('Login',function(){
        ...
        cy.wait(2000);
        cy.get('#username').type('yre002@yopmail.com');
        cy.wait(2000);
        cy.get('#loginPassword').type('Pass2021');
    ...
    it ('How and where is the money received',function(){
        cy.get('#receptionOptionStatesDdl').select('QUERETARO');
        cy.wait(1000);
        cy.get('#receptionOptionCitiesDdl').select('PEDRO ESCOBEDO');
        ...
        cy.xpath('//*[@id="pickUpMethod"]/div[5]/div/div[2]/div/div').click();
        cy.wait(1000);
